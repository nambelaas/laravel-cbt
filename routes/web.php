...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard.')->group(function () {
        ...
        Route::get('/course/students/show/{course}', [CourseStudentController::class, 'index'])->middleware('role:teacher')->name('course.course_student.index');
        Route::get('/course/students/create/{course}', [CourseStudentController::class, 'create'])->middleware('role:teacher')->name('course.course_student.create');
        Route::post('/course/students/save/{course}', [CourseStudentController::class, 'store'])->middleware('role:teacher')->name('course.course_student.store');

        Route::get('/learning/finished/{course}', [LearningController::class, 'learningFinished'])->middleware('role:student')->name('learning.finished.course');
        Route::get('/learning/report/{course}', [LearningController::class, 'learningReport'])->middleware('role:student')->name('learning.report.course');
